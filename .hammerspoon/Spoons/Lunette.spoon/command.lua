...
obj.henlarge = function(windowFrame, screenFrame)
  local newFrame = Resize:henlarge(windowFrame, screenFrame)
  return newFrame
end

obj.hshrink = function(windowFrame, screenFrame)
  local newFrame = Resize:hshrink(windowFrame, screenFrame)
  return newFrame
end

obj.moveLeft = function(windowFrame, screenFrame)
  local newFrame = Resize:moveLeft(windowFrame, screenFrame)
  return newFrame
end

obj.moveRight = function(windowFrame, screenFrame)
  local newFrame = Resize:moveRight(windowFrame, screenFrame)
  return newFrame
end
