...
function obj:henlarge(window, screen)
  --window.x = window.x + 10
  --window.y = window.y + 50
  window.w = window.w + 50
  --window.h = window.h - 50

  return window
end

function obj:hshrink(window, screen)
  --window.x = window.x + 10
  --window.y = window.y + 50
  window.w = window.w - 50
  --window.h = window.h - 50
...
function obj:moveLeft(window, screen)
  window.x = window.x - 50
  return window
end

function obj:moveRight(window, screen)
  window.x = window.x + 50
  return window
end
