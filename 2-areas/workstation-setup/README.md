...
This package is the **setup control plane**: it owns setup intent, profile documentation, manifests, migration instructions, inventory, and orchestration. Active runtime configuration remains at the utils repository root; this package does not create a second configuration tree.
